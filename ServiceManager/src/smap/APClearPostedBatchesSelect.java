...
public class APClearPostedBatchesSelect  extends HttpServlet {
	...
	public void doPost(HttpServletRequest request,
	    ...
	    String title = "Clear posted and deleted AP batches";
	    String subtitle = "";
	    ...
	    out.println("<A HREF=\"" + WebContextParameters.getdocumentationpageURL(getServletContext()) + "#" + Long.toString(SMSystemFunctions.APClearPostedAndDeletedBatches) 
	    	+ "\">Summary</A><BR>");
	    
		out.println ("<FORM ACTION =\"" + SMUtilities.getURLLinkBase(getServletContext()) + "smap.APClearPostedBatchesAction\">");
