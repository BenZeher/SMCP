...
public class APClearTransactionsSelect extends HttpServlet {
	...
	public void doPost(HttpServletRequest request,
	    ...
	    out.println("<A HREF=\"" + WebContextParameters.getdocumentationpageURL(getServletContext()) + "#" + Long.toString(SMSystemFunctions.APClearFullyPaidTransactions) 
	    		+ "\">Summary</A><BR>");
	    
		out.println ("<FORM ACTION =\"" + SMUtilities.getURLLinkBase(getServletContext()) + "smap.APClearTransactionsAction\">");
		out.println("<INPUT TYPE=HIDDEN NAME='" + SMUtilities.SMCP_REQUEST_PARAM_DATABASE_ID + "' VALUE='" + sDBID + "'>");
		out.println("<INPUT TYPE=HIDDEN NAME=CallingClass VALUE=\"" + this.getClass().getName() + "\">");
	    out.println("<BR>NOTE: This will permanently clear all the fully paid Accounts Payable transactions"
	    		+ " (invoices, payments, credits, debits, checks) with document dates up to and including the date you select."
	    		+ "  Any matching lines that APPLY TO those transactions"
