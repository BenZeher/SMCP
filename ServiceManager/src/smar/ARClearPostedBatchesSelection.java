...
public class ARClearPostedBatchesSelection  extends HttpServlet {
	...
	public void doPost(HttpServletRequest request,
	    ...
	    String title = "Clear posted AR batches";
	    String subtitle = "";
	    ...
	    out.println("<A HREF=\"" + WebContextParameters.getdocumentationpageURL(getServletContext()) + "#" + Long.toString(SMSystemFunctions.ARClearpostedbatches) 
	    		+ "\">Summary</A><BR><BR>");
	    
		out.println ("<FORM ACTION =\"" + SMUtilities.getURLLinkBase(getServletContext()) + "smar.ARClearPostedBatchesAction\">");
