...
public class AREditReversalEntry extends HttpServlet {
	...
	private boolean loadGLList(String sDBID, String sUserID, String sUserFullName){
        ...
        try{
	    	...
	    	System.out.println("[1579117089] Error in " + this.toString()+ " class!!");
	...
	private void Display_Line_Header(PrintWriter m_pwOut){
		...
		m_pwOut.println("<TABLE BGCOLOR=\"" + SMMasterStyleSheetDefinitions.BACKGROUND_WHITE + "\"  WIDTH=100% CLASS=\"" + SMMasterStyleSheetDefinitions.TABLE_BASIC_WITH_BORDER +"\">");
