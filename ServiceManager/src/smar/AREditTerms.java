...
public class AREditTerms extends HttpServlet {

	private static final long serialVersionUID = 1L;
	private static final String sObjectName = "Terms";
	private static final String sCalledClassName = "AREditTermsEdit";
	...
	public void doPost(HttpServletRequest request,
		...
		try{
	        ...
	        ResultSet rs = clsDatabaseFunctions.openResultSet(
	     	...
	     	out.println ("<SELECT NAME=\"" + ARTerms.ParamsTermsCode + "\">" );
        	
        	while (rs.next()){
        		sOutPut = "<OPTION VALUE=\"" + rs.getString(SMTablearterms.sTermsCode) + "\">";
        		sOutPut = sOutPut + rs.getString(SMTablearterms.sTermsCode) + " - " + rs.getString(SMTablearterms.sDescription);
	        	out.println (sOutPut);
        	}
        	rs.close();
	    	...
	    	System.out.println("[1579117103] Error in " + this.toString() + " class!!");
