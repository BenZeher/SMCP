...
public class BKMainMenu extends HttpServlet {
	...
	throws ServletException, IOException {
		...
		if(!SMAuthenticate.authenticateSMCPCredentials(
				...
				response, 
				getServletContext(), 
				SMSystemFunctions.BKBankFunctions))
			{
				return;
			}
		...
		String subtitle = "Bank Functions";
	...
	private boolean buildMenus(
		...
		//Master Edit:
		arMenu.clear();
		arMenu.add(SMSystemFunctions.BKEditBanks);
		...
		//Processing
		arMenu.clear();
		arMenu.add(SMSystemFunctions.BKEditStatements);
		arMenu.add(SMSystemFunctions.BKImportBankEntries);
		arMenu.add(SMSystemFunctions.BKClearStatements);
