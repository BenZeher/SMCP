...
public class SMDirectOrderDetailEntry extends clsMasterEntry{
	public static final String ParamObjectName = "Direct entry";
	...
	public SMDirectOrderDetailEntry() {
		super();
		initDirectEntryVariables();
        }

	SMDirectOrderDetailEntry (HttpServletRequest req){
		super(req);
		initDirectEntryVariables();
