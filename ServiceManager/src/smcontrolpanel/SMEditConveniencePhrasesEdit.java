...
public class SMEditConveniencePhrasesEdit extends HttpServlet {
	...
	private void Edit_Record(
		...
		try{
	    	...
	    	System.out.println("[1579269271] Error in " + this.toString()+ " class!!");
	...
	private boolean Delete_Record(
		...
		try {
	    	...
	    	System.out.println("[1579269276] Error in " + this.toString()+ ".Delete_Record class!!");
	        System.out.println("SQLException: " + ex.getMessage());
	        System.out.println("SQLState: " + ex.getSQLState());
	        System.out.println("SQL: " + ex.getErrorCode());
			return false;
	...
	private boolean Add_Record(String sCode, String sDBID, PrintWriter pwOut){
		...
		try{
	    	...
	    	System.out.println("[1579269280] Error in " + this.toString()+ ".Add_Record class!!");
	        System.out.println("SQLException: " + ex.getMessage());
	        System.out.println("SQLState: " + ex.getSQLState());
	        System.out.println("SQL: " + ex.getErrorCode());
			return false;
		...
		try {
	    	...
	    	System.out.println("[1579269285] Error in " + this.toString()+ ".Add_Record class!!");
	        System.out.println("SQLException: " + ex.getMessage());
	        System.out.println("SQLState: " + ex.getSQLState());
	        System.out.println("SQL: " + ex.getErrorCode());
			return false;
