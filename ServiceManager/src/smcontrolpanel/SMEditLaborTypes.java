...
public class SMEditLaborTypes extends HttpServlet {
	...
	private static String sCalledClassName = "SMEditLaborTypesEdit";
	@Override
	public void doPost(HttpServletRequest request,
		...
		try{
        	...
        	while (rs.next()){
        		sOutPut = "<OPTION VALUE=\"" + rs.getString(SMTablelabortypes.sID) + "\">";
        		sOutPut = sOutPut + rs.getString(SMTablelabortypes.sID) + " - " + rs.getString(SMTablelabortypes.sLaborName);
	        	out.println (sOutPut);
        	}
        	rs.close();
	    	...
	    	System.out.println("[1579269737] Error in " + this.toString() + " class!!");
		...
		sOutPut = sOutPut + 
			" New Job Type ID To Be Added: <INPUT TYPE=TEXT NAME=\"New" + sObjectName + "\" SIZE=28 MAXLENGTH=" + 
			"4" + 
