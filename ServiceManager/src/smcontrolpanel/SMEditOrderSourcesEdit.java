...
public class SMEditOrderSourcesEdit extends HttpServlet {
	...
	private static String sCalledClassName = "SMEditOrderSourcesAction";
	...
	private void Edit_Record(
		...
		try{
	        ...
	        sOutPut += clsCreateHTMLTableFormFields.Create_Edit_Form_MultilineText_Input_Row(
	        		...
	        		clsStringFunctions.filter(rs.getString(SMTableordersources.sSourceDesc)), 
	        		"Order Source Description:", 
	        		"A full description of the order source.",
	        		4,
	        		75);
	        rs.close();
