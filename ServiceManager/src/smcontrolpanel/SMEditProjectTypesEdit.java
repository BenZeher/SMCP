...
public class SMEditProjectTypesEdit extends HttpServlet {
	...
	private void Edit_Record(
		...
		try{
	    	...
	    	System.out.println("[1579271105] Error in " + this.toString()+ " class!!");
	...
	private boolean Delete_Record(String sID,
		...
		try {
	    	...
	    	System.out.println("[1579271118] Error in " + this.toString()+ ".Delete_Record class!!");
	        System.out.println("SQLException: " + ex.getMessage());
	        System.out.println("SQLState: " + ex.getSQLState());
	        System.out.println("SQL: " + ex.getErrorCode());
			return false;
	...
	private boolean Add_Record(String sID, String sDBID, PrintWriter pwOut){
		...
		try{
	    	...
	    	System.out.println("[1579271110] Error in " + this.toString()+ ".Add_Record class!!");
	        System.out.println("SQLException: " + ex.getMessage());
	        System.out.println("SQLState: " + ex.getSQLState());
	        System.out.println("SQL: " + ex.getErrorCode());
			return false;
		...
		try {
	    	...
	    	System.out.println("[1579271115] Error in " + this.toString()+ ".Add_Record class!!");
	        System.out.println("SQLException: " + ex.getMessage());
	        System.out.println("SQLState: " + ex.getSQLState());
	        System.out.println("SQL: " + ex.getErrorCode());
			return false;
