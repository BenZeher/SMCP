...
public class SMEditSalesperson extends HttpServlet {

	private static final long serialVersionUID = 1L;
	private static String sObjectName = "Salesperson";
	private static String sCalledClassName = "SMEditSalespersonEdit";
	@Override
	public void doPost(HttpServletRequest request,
		...
		try{
	    	...
	    	System.out.println("[1579271418] Error in " + this.toString() + " class!!");
		...
		sOutPut = sOutPut + 
			" New Salesperson Code To Be Added: <INPUT TYPE=TEXT NAME=\"New" + sObjectName + "\" SIZE=28 MAXLENGTH=" + 
			Integer.toString(SMTablesalesperson.sSalespersonCodeLength) + 
			" STYLE=\"width: 2.41in; height: 0.25in\"> Code length maximum is " + 
			Integer.toString(SMTablesalesperson.sSalespersonCodeLength) + ".</P>";
