...
public class SMEditTaxCertificatesAction extends HttpServlet{
	...
	public void doPost(HttpServletRequest request,
		...
		if (!smaction.processSession(getServletContext(), SMSystemFunctions.SMEditTaxCertificates)){return;}
		smaction.getCurrentSession().removeAttribute(SMTaxCertificate.ParamObjectName);
		    ...
		    if (smaction.isDeleteConfirmed()){
			    ...
			    try {
			    	...
			    	smaction.redirectAction(
				    		...
				    		"", 
				    		SMTaxCertificate.Paramlid + "=" + entry.getslid()
				    		);
						return;
				}
				...
				if (smaction.getOriginalURL().trim().compareToIgnoreCase("") != 0){
					...
					String sRedirectString = 
						"" + SMUtilities.getURLLinkBase(getServletContext()) + "smcontrolpanel.SMEditTaxCertificatesSelect"
	    		...
	    		smaction.getCurrentSession().setAttribute(SMTaxCertificate.ParamObjectName, entry);
				smaction.redirectAction(
