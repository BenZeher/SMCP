...
public class SMSummaryIncorporationLine extends clsMasterEntry{
	...
	SMSummaryIncorporationLine (HttpServletRequest req){
		super(req);
		initBidVariables();
		
		m_llinenumber = clsManageRequestParameters.get_Request_Parameter(SMSummaryIncorporationLine.Paramllinenumber, req);
		m_sitemnumber = clsManageRequestParameters.get_Request_Parameter(SMSummaryIncorporationLine.Paramsitemnumber, req);
		m_sitemdescription = clsManageRequestParameters.get_Request_Parameter(SMSummaryIncorporationLine.Paramsitemdescription, req);
		m_scategorycode = clsManageRequestParameters.get_Request_Parameter(SMSummaryIncorporationLine.Paramsitemcategory, req);
		m_sunitofmeasure = clsManageRequestParameters.get_Request_Parameter(SMSummaryIncorporationLine.Paramsunitofmeasure, req);
		m_squantity = clsManageRequestParameters.get_Request_Parameter(SMSummaryIncorporationLine.Paramsquantity, req).trim();
		...
		m_sestimatedextendedmaterialcost = clsManageRequestParameters.get_Request_Parameter(
				SMSummaryIncorporationLine.Paramsestimatedextendedmaterialcost, req).trim();
		...
		m_sestimatedextendedlaborcost = clsManageRequestParameters.get_Request_Parameter(
				SMSummaryIncorporationLine.Paramsestimatedextendedlaborcost, req).trim();
		...
		m_sextendedmaterialbillingvalue = clsManageRequestParameters.get_Request_Parameter(
				SMSummaryIncorporationLine.Paramsextendedmaterialbillingvalue, req).trim();
		...
		m_sextendedlaborbillingvalue = clsManageRequestParameters.get_Request_Parameter(
				SMSummaryIncorporationLine.Paramsextendedlaborbillingvalue, req).trim();
		...
		m_sgrossprofit = clsManageRequestParameters.get_Request_Parameter(
				SMSummaryIncorporationLine.Paramsgrossprofit, req).trim();
		...
		m_sextendedlaborunits = clsManageRequestParameters.get_Request_Parameter(
				SMSummaryIncorporationLine.Paramsextendedlaborunits, req).trim();
