...
public class SMUpdateData extends java.lang.Object{
	...
	private static final int m_CurrentDatabaseVersion = 1481;
	private static final String m_sVersionNumber = "1.4";
	private static final String m_sLastRevisionDate = "6/12/2020";
...
*/
		   ...
		   //BEGIN CASE:
			...
			case 1375:
				...
				SQL = "ALTER TABLE `gltransactionbatches`"
					+ " ADD COLUMN `screatedbyfullname` varchar(128) NOT NULL default ''"
					+ ", ADD COLUMN `slasteditedbyfullname` varchar(128) NOT NULL default ''"
				;
			...
			//BEGIN CASE:
			case 1377:
				//Added by TJR 5/1/2019
				SQL = "DROP TABLE `glbatches`"
				;
			...
			case 1378:
				//Added by TJR 5/1/2019
				SQL = "ALTER TABLE `apoptions` ADD COLUMN ifeedgl INT(11) NOT NULL DEFAULT '0'";
			...
			case 1379:
				//Added by TJR 5/1/2019
				SQL = "ALTER TABLE `aroptions` ADD COLUMN ifeedgl INT(11) NOT NULL DEFAULT '0'";
			...
			//BEGIN CASE:
			case 1380:
				//Added by TJR 5/2/2019
				SQL = "ALTER TABLE `smoptions` ADD COLUMN ifeedgl INT(11) NOT NULL DEFAULT '0'";
			...
			case 1381:
				//Added by TJR 5/2/2019
				SQL = "ALTER TABLE `icoptions` ADD COLUMN ifeedgl INT(11) NOT NULL DEFAULT '0'";
			...
			case 1395:
				//Added by BJA 6/26/2019
				SQL = "ALTER TABLE `icvendors` "
						+ " add svendoremail varchar(128) NOT NULL DEFAULT ''"
						;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			//BEGIN CASE:
			case 1398:
				//Added by TJR 7/15/2019
				SQL = "ALTER TABLE `glexternalcompanypulls` "
						+ " ADD lstartingtransactionid INT(11) NOT NULL DEFAULT '0'"
						+ ", ADD lendingtransactionid INT(11) NOT NULL DEFAULT '0'"
						;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			case 1399:
				//Added by TJR 7/15/2019
				SQL = "ALTER TABLE `gltransactionlines` "
					+ " ADD lexternalcompanypullid INT(11) NOT NULL DEFAULT '0'"
				;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			case 1400:
				//Added by TJR 7/15/2019
				SQL = "ALTER TABLE `glexternalcompanypulls` "
					+ " DROP lstartingtransactionid"
					+ ", DROP lendingtransactionid"
					;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			case 1403:
				...
				SQL = "ALTER TABLE `gltransactionbatchentries` "
					+ " DROP COLUMN lsourceledgertransactionlineid"
				;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			case 1406:
				//Added by BJA 8/2/2019
				SQL = "ALTER TABLE `gltransactionlines` "
					+ " ADD sSourceledgertransactionlink varchar(24) NOT NULL DEFAULT ''"
				;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			//BEGIN CASE:
			case 1413:
				//Added by BJA 9/27/2019
				SQL = "ALTER TABLE `laborbackcharges` "
					+ " ADD lcostcenterid int(11) NOT NULL DEFAULT '0'"
				;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			//BEGIN CASE:
			case 1416:
				//Added by TJR 10/15/2019
				SQL = "ALTER TABLE `gltransactionbatchentries` "
					+ " CHANGE ssourceledgertransactionid ssourceledgertransactionid VARCHAR(48) NOT NULL DEFAULT ''"
				;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			//BEGIN CASE:
			case 1417:
				//Added by BJA 10/15/2019
				SQL = "ALTER TABLE `salescontacts` "
					+ " ADD sSalespersonName VARCHAR(75) NOT NULL DEFAULT ''"
				;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			//BEGIN CASE:
			case 1418:
				//Added by BJA 10/16/2019
				SQL = "UPDATE `salescontacts`" + 
						"			 LEFT JOIN" + 
						"			 `salesperson`" + 
			...
			case 1419:
				...
				SQL = "INSERT INTO criticaldates " 
						...
						+ " 1," 
						+ " 2,"  
						+ " IF(users.lid IS NULL, 0, users.lid)," 
						+ " IF(users.sUserFirstName IS NULL, IF(salesperson.sSalespersonCode IS NULL,'',CONCAT(salesperson.sSalespersonFirstName, ' ', salesperson.sSalespersonLastName)), CONCAT(users.sUserFirstName, ' ', users.sUserLastName)),"  
						+ " IF(users.lid IS NULL, 0, users.lid)," 
						+ " IF(users.sUserFirstName IS NULL, IF(salesperson.sSalespersonCode IS NULL,'',CONCAT(salesperson.sSalespersonFirstName, ' ', salesperson.sSalespersonLastName)), CONCAT(users.sUserFirstName, ' ', users.sUserLastName)),"  
						+ " mfollwupnotes"  
						+ " FROM bids" 
			...
			//BEGIN CASE:
			case 1428:
				//Added by TJR 11/12/2019
				SQL = "ALTER TABLE gltransactionlines DROP KEY `uniquetransactionkey` ";
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			//END CASE
			...
			case 1429:
				//Added by TJR 11/12/2019
				SQL = "ALTER TABLE gltransactionlines ADD UNIQUE KEY `uniquetransactionkey`("
					+ "loriginalbatchnumber, loriginalentrynumber, loriginallinenumber, ifiscalyear, ifiscalperiod, lexternalcompanypullid) ";
				;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			//BEGIN CASE:
			case 1430:
				//Added by TJR 11/19/2019
				SQL = "ALTER TABLE glexternalcompanypulls ADD COLUMN `ipulltype` INT(11) NOT NULL DEFAULT '0'";
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			//END CASE
			...
			case 1431:
				//Added by TJR 11/19/2019
				SQL = "ALTER TABLE glexternalcompanypulls ADD COLUMN `ireversed` INT(11) NOT NULL DEFAULT '0'";
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			//END CASE		
			...
			//BEGIN CASE:
			case 1432:
				//Added by TJR 11/20/2019
				SQL = "ALTER TABLE glfiscalperiods DROP COLUMN `ilockadjustmentperiod`, DROP COLUMN `ilockclosingperiod`";
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			//END CASE	
			...
			case 1433:
				...
				SQL = "ALTER TABLE `orderheaders` "
						+ " ADD mAddressNotes MEDIUMTEXT NOT NULL"
						;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			//BEGIN CASE:
			case 1437:
				//Added by TJR 12/11/2019
				SQL = "ALTER TABLE `glfiscalperiods` "
						+ "ADD ilockclosingperiod int(11) NOT NULL default '1'"
						;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			//BEGIN CASE:
			case 1438:
				//Added by BJA 12/18/2019
				SQL = "ALTER TABLE `materialreturns` "
						+ " ADD mVendorComments MEDIUMTEXT NOT NULL"
						;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			//BEGIN CASE:
			case 1444:
				//Added by BJA 1/23/2020
				SQL = "ALTER TABLE `materialreturns` "
						+ "ADD iCreditDue int(11) NOT NULL default '0'"
						;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			case 1445:
				//Added by BJA 1/23/2020
				SQL = "ALTER TABLE `appointments` "
						+ "MODIFY sshiptoname varchar(120) NOT NULL default ''"
						;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			case 1446:
				//Added by BJA 1/23/2020
				SQL = "ALTER TABLE `appointments` "
						+ "MODIFY sbilltoname varchar(120) NOT NULL default ''"
						;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			case 1447:
				//Added by BJA 1/23/2020
				SQL = "ALTER TABLE `appointments` "
						+ "MODIFY scontactname varchar(120) NOT NULL default ''"
						;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			case 1456:
				//Added by TJR 3/9/2020
				SQL = "ALTER TABLE `apbatchentries`"
					+ " ADD lonholdpoheaderid int(11) NOT NULL DEFAULT '0' COMMENT '[050101]'"
				;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			//BEGIN CASE:
			case 1459:
				//Added by TJR 4/8/2020
				SQL = "ALTER TABLE `icvendors`"
					+ " ADD ionpaymenthold int(11) NOT NULL DEFAULT '0'"
				;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			case 1467:
				//Added by TJR 4/23/2020
				SQL = "INSERT INTO `ohdirectsettings` ("
					+ "`sclientid`, `sclientsecret`, `stokenurl`, `stokenusername`, `stokenuserpassword`, `srequesturlbase`"
					+ ") VALUES ('', '', '', '', '', '')"
				;
			...
			//BEGIN CASE:
			case 1469:
				//Added by BJA 5/14/2020
				SQL = "ALTER TABLE `workorders`"
					+ " ADD iViewPrices int(11) NOT NULL DEFAULT '0'"
				;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			//BEGIN CASE:
			case 1476:
				//Added by TJR 6/2/2020
				SQL = "ALTER TABLE `smestimatesummaries`"
					+ " ADD COLUMN bdtaxrate DECIMAL(17,4) NOT NULL DEFAULT '0.0000'"
				;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			case 1477:
				//Added by TJR 6/2/2020
				SQL = "ALTER TABLE `smestimatesummaries`"
					+ " ADD COLUMN icalculatetaxonpurchaseorsale INT(11) NOT NULL DEFAULT '0'"
					+ ", ADD COLUMN icalculatetaxoncustomerinvoice INT(11) NOT NULL DEFAULT '0'"
				;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			//BEGIN CASE:
			case 1478:
				//Added by TJR 6/3/2020
				SQL = "ALTER TABLE `smestimatesummaries`"
					+ " CHANGE COLUMN bdadjustedlmarkupamt bdadjustedmarkupamt DECIMAL(17, 2) NOT NULL default '0.00'"
				;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
			...
			//BEGIN CASE:
			case 1480:
				//Added by TJR 6/11/2020
				SQL = "ALTER TABLE `smestimates`"
					+ " ADD COLUMN `svendorquoteid` VARCHAR(64) NOT NULL default ''"
				;
				if (!execUpdate(sUser, SQL, conn, iSystemDatabaseVersion)){return false;}
				iVersionUpdatedTo = iSystemDatabaseVersion + 1;
			break;	
