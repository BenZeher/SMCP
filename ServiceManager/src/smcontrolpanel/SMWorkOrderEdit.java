...
//	}
	...
	private String sCommandScripts(
		...
		s += "function changePrice(){\n"
			...
			+ "    }\n"
			+ "	 flagDirty();\n"
			 + "   var discount = document.getElementById('" + SMWorkOrderHeader.ParamdPrePostingWODiscountAmount + "').value	;\n"
			 + " if(discount != 0.0){\n"
			 + " alert(\"The total has potentially been changed so the discount is cleared. Please SAVE your changes BEFORE you re-enter the discount.\");"
			 + " }\n"
