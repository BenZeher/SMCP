...
public class FAEditLocationAction extends HttpServlet{
	...
	public void doPost(HttpServletRequest request,
	    ...
	    String sSQL = "UPDATE " + SMTablefalocations.TableName
					+ " SET " 
					+ SMTablefalocations.sLocDescription + " = '" + request.getParameter(SMTablefalocations.sLocDescription) + "'"
					
					+ " WHERE " + SMTablefalocations.sLocLocation+ " = '" + request.getParameter("EditCode") + "'";
	    ...
	    try{
			...
			System.out.println("[1579189449] Error in " + this.toString() + " class!!");
