...
public class GLAccountStructureSelect extends HttpServlet {

	private static final long serialVersionUID = 1L;

	private static String sCalledClassName = "GLAccountStructureEdit";
	private static String sDBID = "";
	private static String sUserID = "";
	private static String sUserFullName = "";
	private static String sCompanyName = "";
	public static final String OBJECT_NAME = GLAccountStructure.ParamObjectName;
	...
	public void doPost(HttpServletRequest request,
	    ...
	    out.println("<A HREF=\"" + WebContextParameters.getdocumentationpageURL(getServletContext()) + "#" + Long.toString(SMSystemFunctions.GLEditAccountStructures) 
	    		+ "\">Summary</A><BR><BR>");
		...
		try{
	        String sSQL = "SELECT * FROM " + SMTableglaccountstructures.TableName
	        	+ " ORDER BY " + SMTableglaccountstructures.TableName + "." + SMTableglaccountstructures.sstructureid
	        ;
	        ...
	        out.println("<I><U><B>GL Account Structure:</B></U></I><BR>");
	     	out.println ("<SELECT NAME=\"" + SMTableglaccountstructures.lid + "\">" );
	     	String sSelected = "";
        	while (rs.next()){
        		String sLid = Long.toString(rs.getLong(SMTableglaccountstructures.lid));
        		if (entry.getlid().compareToIgnoreCase(sLid) == 0){
        			sSelected = "selected";
        		}else{
        			sSelected = "";
        		}
        		out.println ("<OPTION " + sSelected + " VALUE=\"" + Long.toString(rs.getLong(SMTableglaccountstructures.lid)) + "\">");
        		out.println (rs.getString(SMTableglaccountstructures.TableName + "." + SMTableglaccountstructures.sstructureid) + " - " 
        			+ rs.getString(SMTableglaccountstructures.TableName + "." + SMTableglaccountstructures.sdescription)
        		);
        	}
        	rs.close();
