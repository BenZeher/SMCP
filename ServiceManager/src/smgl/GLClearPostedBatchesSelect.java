...
public class GLClearPostedBatchesSelect  extends HttpServlet {
	...
	public void doPost(HttpServletRequest request,
	    ...
	    String title = "Clear posted and deleted GL batches";
	    String subtitle = "";
	    ...
	    out.println("<A HREF=\"" + WebContextParameters.getdocumentationpageURL(getServletContext()) + "#" + Long.toString(SMSystemFunctions.GLClearPostedAndDeletedBatches) 
	    	+ "\">Summary</A><BR>");
	    
		out.println ("<FORM ACTION =\"" + SMUtilities.getURLLinkBase(getServletContext()) + "smgl.GLClearPostedBatchesAction\">");
