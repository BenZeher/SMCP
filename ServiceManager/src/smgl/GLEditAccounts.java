...
public class GLEditAccounts extends HttpServlet {
	...
	public void doPost(HttpServletRequest request,
	    ...
	    out.println("<A HREF=\"" + WebContextParameters.getdocumentationpageURL(getServletContext()) + "#" + Long.toString(SMSystemFunctions.GLEditChartOfAccounts) 
	    		+ "\">Summary</A><BR><BR>");
	    out.println("<FORM NAME='MAINFORM' ACTION='" + SMUtilities.getURLLinkBase(getServletContext()) + "smgl." + "GLEditAccountsEdit" + "' METHOD='POST'>");
		...
		try{
	        ...
	        ResultSet rs = clsDatabaseFunctions.openResultSet(
	     	...
	     	out.println ("<SELECT NAME=\"" + GLAccount.Paramsacctid + "\">" );
        	
        	while (rs.next()){
        		sOutPut = "<OPTION VALUE=\"" + rs.getString(SMTableglaccounts.sAcctID) + "\">";
        		sOutPut = sOutPut + rs.getString(SMTableglaccounts.sAcctID) + " - " + rs.getString(SMTableglaccounts.sDesc);
	        	out.println (sOutPut);
        	}
        	rs.close();
	    	...
	    	System.out.println("[1579190502] Error in " + this.toString() + " class!!");
