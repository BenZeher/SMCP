...
public class ICEditAccountSetsSelection extends HttpServlet {
	...
	public void doPost(HttpServletRequest request,
		...
		String sObjectName = "Account Set";
	    String sCalledClassName = "ICEditAccountSetsEdit";
		...
		try{
	        String sSQL = "SELECT * FROM " + SMTableicaccountsets.TableName 
	        	+ " ORDER BY " + SMTableicaccountsets.sAccountSetCode;
	        ResultSet rs = clsDatabaseFunctions.openResultSet(
	     	...
	     	out.println ("<SELECT NAME=\"" + ICAccountSet.ParamAccountSetCode + "\">" );
        	
        	while (rs.next()){
        		out.println ("<OPTION VALUE=\"" + rs.getString(SMTableicaccountsets.sAccountSetCode) + "\">");
        		out.println (rs.getString(SMTableicaccountsets.sAccountSetCode) + " - " + rs.getString(SMTableicaccountsets.sDescription));
        	}
        	rs.close();
	    	...
	    	System.out.println("[1579191127] Error in " + this.toString() + " class!!");
