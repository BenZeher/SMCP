...
public class ICEditShipmentEntry extends HttpServlet {
	...
	private static String sObjectName = "Shipment Entry";
	...
	private void Display_Line_Header(){
		...
		m_pwOut.println("<TD VALIGN=TOP><FONT SIZE=2><B><U>Item description</B></U></FONT></TD>");
		...
		m_pwOut.println("<TD VALIGN=TOP><FONT SIZE=2><B><U>Qty Shipped/Returned</B></U></FONT></TD>");
		m_pwOut.println("<TD VALIGN=TOP><FONT SIZE=2><B><U>Cost</B></U></FONT></TD>");
		m_pwOut.println("<TD VALIGN=TOP><FONT SIZE=2><B><U>Price</B></U></FONT></TD>");
		m_pwOut.println("<TD VALIGN=TOP><FONT SIZE=2><B><U>Category</B></U></FONT></TD>");
