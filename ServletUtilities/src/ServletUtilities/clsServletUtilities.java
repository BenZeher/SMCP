...
public class clsServletUtilities {
	...
	public static String getAbsoluteRootPath(HttpServletRequest req, ServletContext context){
		...
		if (WebContextParameters.getInitWebAppName(context) != null){
			sPath = System.getProperty( "catalina.base" ) 
					...
					+ System.getProperty("file.separator") + WebContextParameters.getInitWebAppName(context);
		}else{
	...
	public static String getMasterStyleSheetLink(){
		...
		return "\n<link rel=\"stylesheet\" type=\"text/css\" href=\"styles/MasterStyleSheet.css?v=1.3\" media=\"all\" />\n"
