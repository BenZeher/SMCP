...
public class EmployeeLeaveManagerCriteriaSelection extends HttpServlet {
	...
	public void doGet(HttpServletRequest request,
	    ...
	    try {
        	...
        	out.println ("<FORM ACTION =\"" + ConnectionPool.WebContextParameters.getURLLinkBase(getServletContext()) + "TimeCardSystem.EmployeeLeaveManager\">");
	        ...
	        // handle any errors
	    	System.out.println("Error in EmployeeLeaveManagerCriteriaSelection class!!");
