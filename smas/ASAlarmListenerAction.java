...
public class ASAlarmListenerAction extends HttpServlet{
	...
	private static final String ALARM_LISTENER_USERID = "0";
	...
	public void doPost(HttpServletRequest request,
		...
		log.writeEntry(
			...
			"Query string from controller " +sControllerName + ": Query string: '" + request.getQueryString() + "'", 
			"[1458694548]");
		...
		try {
			...
			log.writeEntry(
				...
				"Controller " +sControllerName +": Error validating passcode '" + sPasscode + "'",
				e1.getMessage(),
				"[1463507195]");
