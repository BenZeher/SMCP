...
public class ASAuthorizeAlarmUsersEdit extends HttpServlet {
	...
	public void doPost(HttpServletRequest request,
		...
		out.println(
			"<A HREF=\"" + SMUtilities.getURLLinkBase(getServletContext()) + "smas.ASMainMenu?" + SMUtilities.REQUEST_PARAM_SESSIONTAG + "=" 
			+ sSessionTag + "\">Return to Alarm Systems Main Menu</A><BR>");
		out.println("<INPUT TYPE=HIDDEN NAME='" + SMUtilities.REQUEST_PARAM_SESSIONTAG + "' VALUE='" + sSessionTag + "'>");
