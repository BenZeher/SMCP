...
public class ASDeviceStatusAction extends HttpServlet{
	...
	public void doPost(HttpServletRequest request,
		...
		try {
			entry.load(getServletContext(), smaction.getConfFile(), smaction.getUserName(), smaction.getUserID(), smaction.getFullUserName());
		} catch (Exception e1) {
			smaction.redirectAction(
		...
		ASUserEventLogEntry usereventlog = new ASUserEventLogEntry(smaction.getConfFile(), getServletContext());
		try {
